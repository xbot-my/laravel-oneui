            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.layout') }}">Page, Block, Sidebar, Header...</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.forms') }}">All Form Components</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.tables') }}">Table, DataTables</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.charts') }}">ChartJS, Sparkline, EasyPieChart</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.metrics') }}">StatWidget, StatGroup, Tiles...</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.calendar') }}">FullCalendar</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.editors') }}">CKEditor, SimpleMDE</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.upload') }}">Dropzone, ImageCropper</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.navigation') }}">Nav, Tabs, Breadcrumb, Steps...</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.notifications') }}">Alert, Modal, Toast, SweetAlert2...</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.media') }}">Image, Gallery, Carousel...</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.lists') }}">DataList, Tree, Timeline...</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.cards') }}">Card, UserCard, PostCard...</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <x-oneui::block>
                        ...
                        <ul class="nav nav-sm nav-pills flex-column">
                            <li class="nav-item"><a class="nav-link" href="{{ route('examples.utilities') }}">Icons, Animations, CodeHighlight...</a></li>
                        </ul>
                    </x-oneui::block>
                </div>
            </div>
